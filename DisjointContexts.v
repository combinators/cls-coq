...
Module Type DisjointTypeSig(Import Types: TypeSignature).
  ...
  Parameter SymbolsFull: forall C, { n: _ | SymbolOf n C }.
  Parameter SymbolsUnrelated:
    forall C1 C2 n m,
  ...
  Parameter VariablesFull: forall alpha, { n : _ | VariableOf n alpha }.
End DisjointTypeSig.

Module Type DisjointTypes
       (Import TySig: TypeSignature)
       (Import DisjointSig: DisjointTypeSig(TySig))
       (Import Types: IntersectionTypes(TySig)).
...
Module Type DisjointCombinatoryLogic
  ...
  Section CombinedContext.
    ...
    Proof.
      ...
      - assumption.
      - revert n_ineq contexts contextsWF path_c.
        generalize TypeSchemeOf.
        generalize numberOfContexts.
        intros numberOfContexts TypeSchemeOf n_ineq contexts contextsWF path_c.
    ...
    Proof.
      ...
      generalize numberOfContexts.
      intros numberOfContexts TypeSchemeOf TypeOf WF_respectful singular_context contexts.      
      destruct numberOfContexts as [ | n ].
